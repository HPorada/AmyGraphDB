...
# sq.subgraph_from_interactions(db_Nov, "Slower aggregation", "Yes; implied by kinetics.", "No information", "interactions4")
...
vf.graphviz_graph('test.json')
vf.networkx_graph('test.json')
