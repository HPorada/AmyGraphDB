...
sq.subgraph_from_interactions(db_Nov, "Faster aggregation", "No information", "No information", "interactions4")
...
vf.graphviz_graph('interactions4.json')
vf.networkx_graph('interactions4.json')
