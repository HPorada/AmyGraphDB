...
class TestAdditionalFunctions(unittest.TestCase):
    ...
    @classmethod
    def setUpClass(cls):
        cls.database = i.database_start("testDB", USERNAME, PASSWORD, "extendedV2")
    ...
    def test_filter_question_extendedV2(self):
        q.filter_questions_extendedV2(self.database, q1="Slower aggregation", q2="No", q3="No information",
                                      filename="test_filter_1",
        ...
        q.filter_questions_extendedV2(self.database, filename="test_filter_3", directory="tests\\test_json_data")
